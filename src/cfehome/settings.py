...
# you can test by python manage.py sendtestemail --admin
...
ALLOWED_HOSTS = [
    ".railway.app",  # https://saas.prod.railway.app  --> like that 
]
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     # Custom app for tracking visits
    'visits', 
    # app for management commands
    'commando', 
